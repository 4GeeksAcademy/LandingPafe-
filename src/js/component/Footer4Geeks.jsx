...
export const Footer = () => (
  ...
  >
    <p className="">
      Made with 🍑 by
      <a
        href="https://github.com/Emma4212" //añadir tu github
      >{" "}
        <img
          className="logo"
          src="https://avatars.githubusercontent.com/u/110198302?v=4"  // añadir una imagen, truco usar la de tu avatar de github
          style={{
          ...
          alt="logo"
        />
        {" "} Enma4212 {/* aqui se vera el texto en enlace, añadir tu propio Nick  */}
      </a>{"  "}
      on
